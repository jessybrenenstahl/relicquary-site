...
*Every page of relicquary.com as one machine-readable Markdown document. Relicquary is a local-first memory operating system for AI agents, an MCP-native tool surface; AIM is a governance architecture for verifiable autonomy built on it. RQ MCP LLC.*
